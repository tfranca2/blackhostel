...
?>
	...
	<!-- 
	<form action="<?php echo site_url();?>/mesa/searching">
	<div class="row">
	...
	<div class="row">
		<div class="col-md-1 col-often-11 form-group pull-right">
			<a class="btn btn-info" href="<?php echo site_url();?>/mesa/inserting">Novo</a>
		</div>
	</div>
	</form>
	<div class="row">
		...
		<table class="table table-striped table-bordered table-responsive"> 
			...
			<tr>
				...
				<td>
					<a href="<?php echo site_url();?>/mesa/detail/<?php  echo $quarto->id_quarto ?>" class="btn btn-default btn-sm detail" title="Detalhes" > <span class="glyphicon glyphicon-search"></span> </a>
					<a href="<?php echo site_url();?>/mesa/editing/<?php  echo $quarto->id_quarto ?>" class="btn btn-default btn-sm" title="Editar" > <span class="glyphicon glyphicon-edit"></span> </a>
					<a href="<?php echo site_url();?>/mesa/deleting/<?php  echo $quarto->id_quarto ?>" class="btn btn-default btn-sm" title="Deletar" > <span class="glyphicon glyphicon-remove"></span> </a>
				</td>
			</tr>
			<?php } ?>
		</table> 
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Detalhamento de Mesa</h4>
		  </div>
...
<div class="row">
	<div class="col-md-6 form-group">
	  <?php
		...
		echo form_input(array('name'=>'numero','id'=>'preco','class'=>'form-control','placeholder'=>'Número da mesa'),set_value('numero'));
	  ?>
	</div>
</div>
<div class="row">
...
<div class="row">
	...
	<div class="col-md-6 form-group">
		<a class="btn btn-info" href="<?php echo site_url();?>/mesa" class="button success">Voltar</a>  
	</div>
</div>
...
<div class="row">
	<div class="col-md-6 form-group">
	  <?php
		echo form_label('Número');
		echo form_input(array('name'=>'numero','id'=>'preco','class'=>'form-control','placeholder'=>'Número da mesa'),$quarto->numero);
	  ?>
	</div>
</div>
<div class="row">
	<div class="col-md-6 form-group">
	  ...
	  <option > -- Selecione -- </option>
			<?php foreach($perfils as $perfil){ ?>
				<option value="<?php echo $perfil->id_perfil ?>" <?php echo ($perfil->id_perfil == $quarto->idperfil)?'selected="true"':'' ?> ><?php echo $perfil->descricao ?> </option>
			<?php } ?>
		</select>
	</div>
</div>
