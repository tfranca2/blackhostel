...
(function($) {
    ...
    $.fn.DualListBox = function(paramOptions, selected) {
        return this.each(function () {
            var defaults = {
				...
				available:  'Available',        // Items still availables to select.
				selected:   'Selected',		    // Items already seleteds.
				showing:    'showing',          // Show items that remains in both side.
				filterLabel:'Filter',           // The placeholder that are going to be in field filter
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).append(
                ...
                '       <h4><span class="unselected-title"></span> <small>- '+options.showing+' <span class="unselected-count"></span></small></h4>' +
                ...
                (options.horizontal == false ? '   <div class="col-md-5">' : '   <div class="col-md-6">') +
                '       <h4><span class="selected-title"></span> <small>- '+options.showing+' <span class="selected-count"></span></small></h4>' +
        ...
        $(options.parentElement + ' .unselected-title').text(options.available);
        $(options.parentElement + ' .selected-title').text(options.selected);
    }
